package cosmin.criptochat.android.FireChatHelper;
...
public class ReferenceUrl {
    ...
    public static final String FIREBASE_CHAT_URL="https://criptochat-39436.firebaseio.com/"; //Your app main firebase url
